...
class MyMaterialPageRoute<T> extends TransparentMaterialPageRoute<T> {
  MyMaterialPageRoute({
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    if (nextRoute is MyMaterialPageRoute && !nextRoute.fullscreenDialog) {
      return true;
    }
  ...
  bool canTransitionFrom(TransitionRoute previousRoute) {
    if (previousRoute is MyMaterialPageRoute) {
      return true;
    }
